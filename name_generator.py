...
class NameGenerator:
    """English name generator using component-based construction"""
    ...
    def _generate_component(cls, pattern):
        """Generate a name component based on pattern"""
        components = []
        for part in pattern:
            if part == 'prefix':
...
def generate_email():
    """Generate a random personal email address. Uses personal email domains (not school) since military personnel don't use .edu addresses."""
...
def generate_birth_date():
    """Generate a random birth date for veterans (age range ~40-70)."""
...
def generate_discharge_date():
    """Generate a random military discharge date (2015-2024)."""
